...
the fitting equation for the bandwidth is shown in Eq. \ref{eq:eps_1}.
\begin{equation}
\label{eq:eps_1}
...
distribution of $\theta$=$0\,^{\circ}$ and $\theta$=$90\,^{\circ}$ as shown in Fig. \ref{fig:7}. The fitted gain difference curve equation of horizontal polarization is shown in Eq. \ref{eq:eps_2}.
\begin{equation}
\label{eq:eps_2}
...
the maximum. The fitting equation for S11 of vertical polarization is shown in Eq. \ref{eq:eps_4}.
\begin{equation}
\label{eq:eps_4}
...
polarization take the maximum and the bandwidth is the narrowest, the antenna is not suitable for placing on human body
surface. The S11 curve of horizontal polarization is flat and when $d$=4cm, $B$ reaches the maximum, the
...
distributed with  $0\,^{\circ}$ and $90\,^{\circ}$ respectively. The gain difference of horizontal polarization is described by Eq. \ref{eq:eps_5}.
\begin{equation}
\label{eq:eps_5}
...
$\theta$=$130\,^{\circ}$ and $\theta$=$550\,^{\circ}$, $\mid$$G_{b}$-$G_{f}$$\mid$=12, reaches the maximum, human body has the greatest effect on antenna gain pattern.
...
\label{fig:11}
\end{figure}
For horizontal polarization, the fitting curve equation of bandwidth is shown as Eq. \ref{eq:eps_6}.
\begin{equation}
\label{eq:eps_6}
...
vertical polarization, the fitted curve equation of bandwidth is shown in Eq. \ref{eq:eps_7}.
\begin{equation}
\label{eq:eps_7}
...
polarization and horizontal polarization is consistent, and the fitting curve equation is shown in Eq. \ref{eq:eps_8} and Eq. \ref{eq:eps_9}.
\begin{equation}
\label{eq:eps_8}
