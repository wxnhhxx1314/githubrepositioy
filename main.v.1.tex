...
and scattering effects also bring challenges in the design of miniatured on-body antennas. Characteristics of antennas
...
summarize the variation of S11 and bandwidth($B$) in the range of 0.5cm$<$d$<$6cm, and compare the changes of antenna
...
matching is the best; When 0.5cm$<$d$<$1.5cm, S11 of vertical polarization decreases with the increase of $d$ and when
$d$=1.5cm, S11 reaches the minimum and the antenna matching performance is the best, when 1.5cm$<$d$<$4cm, S11
increases with the increase of d, and the antenna matching performance get worse. When 0.5cm$<$d$<$1.2cm, $d$$>$2cm,
the horizontal polarization of S11 is always smaller than vertical polarization. Horizontal polarization of the antenna
...
maximum. The fitting equation for S11 of vertical polarization is shown in Eq. \ref{eq:eps_4}
